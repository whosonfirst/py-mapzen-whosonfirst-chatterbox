...
egg_info = cwd + "/mapzen.whosonfirst.chatterbox.egg-info"
...
setup(
    ...
    author='Mapzen',
    url='https://github.com/whosonfirst/py-mapzen-whosonfirst-chatterbox',
    install_requires=[
        'redis',
        ],
    dependency_links=[
    ...
    download_url='https://github.com/whosonfirst/py-mapzen-whosonfirst-chatterbox/releases/tag/' + version,
    license='BSD')
